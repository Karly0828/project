...
//            query.bindValue(":id",NULL);
            ...
            if(!query.exec())
                {
                    QMessageBox::information(this,"querry",query.lastError().text().toLocal8Bit().data());
                }
                else
                {
                    QMessageBox::information(this,"querry","Insert successfully");
                }
            }
}
...
//        std::vector <cv::String> Simlist;
        ...
        if(!query_color_pre.exec()){
            QMessageBox::information(this,"querry",query_color_pre.lastError().text());
        }else{

        QMessageBox::information(this,"titiel","Color-Based");
...
//        double tkpt, tdes;
        ...
        if(!query_edge_pre.exec()){
            QMessageBox::information(this,"querry",query_edge_pre.lastError().text());
        }else{
            ...
            {
                QMessageBox::information(this,"Warning","Please input integers from 0 to 250, or it will be detect by default from 80 to 150.");
            }else{
        ...
        QMessageBox::information(this,"titiel","Canny-Based Edge Detection");
...
//         delete ui->label_show_6;
    ...
    if(ui->radioButton_multi->isChecked()){
        ...
        if(!(flag_color&&flag_edge)){
            QMessageBox::information(this,"titiel","Please make sure both methods above have been executed first.");
        }else{
            ...
            {
                QMessageBox::information(this,"Warning","Please input integers more than 0, or it will be calculate by default 50% and 50%.");
            }else{
            ...
            QMessageBox::information(this,"titiel","Multi-Features Fusion");
...
void MainWindow::on_pushButton_upload_clicked()
{
    ...
    if(fileDlg.exec() == QDialog::Accepted)
    {
        ...
        if(strPathList.isEmpty())
        {
           QMessageBox::information(this,"querry","No file selected");
        }else
...
//       }
       ...
       if(!query.exec())
           ...
           {
               QMessageBox::information(this,"querry","Upload successfully");
           }
    }
...
void MainWindow::on_pushButton_Histogram_clicked()
{
    Mat src, dst, dst1;
        ...
        if (!src.data)
        {
            QMessageBox::information(this,"querry","Image Load Faild");
        }else{
